package hrsoft.monitor_android.util;
...
import static hrsoft.monitor_android.util.ScreenUtil.sp2px;
...
public class DialogUtils {
    ...
    public DialogUtils setTitleText(String titleText) {
        ...
        titleTxt.setTextColor(mContext.getResources().getColor(R.color.primary_text));
    ...
    public DialogUtils setInputHintText(String inputHintText) {
        ...
        inputHintTxt.setTextColor(mContext.getResources().getColor(R.color.secondary_text));
...
//    }
    ...
    public DialogUtils showAlertDialog() {
        ...
        if (needNegativeButton) {
            ...
            negativeButton.setTextColor(mContext.getResources().getColor(R.color.primary_text));
            negativeButton.setTextSize(mContext.getResources().getInteger(R.integer.dialog_button_txt_size));
        }
        if (needPositiveButton) {
            Button positiveButton = dialog.getButton(AlertDialog.BUTTON_POSITIVE);
            positiveButton.setTextColor(mContext.getResources().getColor(R.color.primary_text));
